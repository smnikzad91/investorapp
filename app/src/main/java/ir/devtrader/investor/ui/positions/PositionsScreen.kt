package ir.devtrader.investor.ui.positions
...
@Composable
fun PositionsScreen(investorRepository: InvestorRepository, modifier: Modifier = Modifier) {
    val viewModel: PositionsViewModel = viewModel(factory = PositionsViewModel.factory(investorRepository))
    ...
    when {
        ...
        uiState.positions.isEmpty() -> Text(
            ...
            items(uiState.positions.size) { index ->
                GenericRecordCard(uiState.positions[index])
            }
        }
    }
}
